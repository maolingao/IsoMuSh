...
extern int *BP;				/* The back pointer array of the heap.			   */
...
/***************************************************************************/
void upheap(int k)
// 	int             k;	/* index to the element to be moved up the heap    */
{
...
void
downheap(int k)
// 	int             k;	/* index to the element to be moved down the
// 						   heap */
{
	double          u = a[k].u;	/* current value */
	int             v = a[k].v;
